...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Notely — Turn anything into notes you actually remember" },
      {
        name: "description",
        content:
          "Notely turns YouTube videos, PDFs, audio and websites into structured notes, flashcards, quizzes and podcasts. Private by default.",
      },
      { property: "og:title", content: "Notely — Notes that actually stick" },
      {
        property: "og:description",
        content:
          "Drop in a link, a PDF, or a recording. Notely turns it into notes, flashcards, quizzes and audio recaps.",
      },
    ],
  }),
  component: Landing,
...
function BentoGrid() {
  const cell =
    "group relative overflow-hidden rounded-3xl border border-border bg-card p-6 shadow-sm transition-all hover:-translate-y-1 hover:shadow-lg md:p-8";
  const item = {
