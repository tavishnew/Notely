...
const DEFAULT_CALLOUT_EMOJI = "üìå";
...
export function markdownToBlocks(md: string): Block[] {
  ...
  while (i < lines.length) {
    ...
    // blockquote / callout "î merge consecutive `>` lines
    ...
    // paragraph "î merge consecutive plain lines until a blank line or another
    // block type starts.
...
/** Inverse of markdownToBlocks "î round-trips the common block types. */
...
/** KaTeX render of a LaTeX string to an HTML string. Pure string generation "î
...
/** Strip a code fence that wraps the ENTIRE string "î models often wrap their
